...
**Note:** Due to bundler limitations, the name of your project (e.g. `$PROJECT_NAME`) must only contain letters, numbers and underscores due to a bundler limitation.
